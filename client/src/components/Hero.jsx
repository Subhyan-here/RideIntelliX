...
const Hero = () => {
  ...
  return (
    ...
    bg-light text-center'>
        ...
        className='text-4xl md:text-5xl font-semibold'>Luxury two-wheelers on Rent</motion.h1>
    ...
    gap-10 min-md:ml-8'>
        <div className='flex flex-col items-start gap-2'>
         ...
         <div className='flex flex-col items-start gap-2'>
            ...
            <input type="data" id="pickup-date" min={new Date().toISOString().split('T')[0]} className='text-sm text-gray-500' required/>
        </div>

        <div className='flex flex-col items-start gap-2'>
            <label htmlFor='return-date'>Return Date</label>
            <input type="data" id="return-date" className='text-sm text-gray-500' required/>
        </div>
