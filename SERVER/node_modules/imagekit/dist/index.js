...
var ImageKit = /** @class */ (function () {
    function ImageKit(opts) {
        ...
        this.options = {
            uploadEndpoint: "",
            publicKey: "public_WjYw3cylcqeX1XNvb8ugXhQ85qs=",
            privateKey: "private_WgmvBf/NiYlYEoaQG4NeKqMxA2I=",
            urlEndpoint: "https://ik.imagekit.io/21iumgsmi",
         ...
         * @returns \{ `timestamp
         * `: Verified UNIX epoch timestamp if signature, `event`: Parsed webhook event payload \}
         */
